...
if (( ${NUMARGS} == 0 )) || hasArg libcuml || hasArg prims || hasArg bench; then
    ...
    cmake -DCMAKE_INSTALL_PREFIX=${INSTALL_PREFIX} \
          ...
          -DLAPACK_LIBRARIES=/autofs/nccs-svm1_sw/summit/.swci/1-compute/opt/spack/20180914/linux-rhel7-ppc64le/gcc-6.4.0/netlib-lapack-3.8.0-wcabdyqhdi5rooxbkqa6x5d7hxyxwdkm/lib64/liblapack.so \
          ${GPU_ARCH} \
